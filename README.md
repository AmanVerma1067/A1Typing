...
* **Continuous Paragraph Engine:** Sentence pool dynamically scales to prevent text running out, supporting short (15s), medium (30s), long (60s), custom (5s to 300s range slider), and Infinite/Free Run (count-up elapsed time) duration settings.
